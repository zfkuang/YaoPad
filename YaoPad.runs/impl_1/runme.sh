...
HD_PWD='E:/XilinxProjects/YaoPad/YaoPad/YaoPad.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log openmips_min_sopc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source openmips_min_sopc.tcl -notrace
